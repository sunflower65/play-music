...
class SingsList extends Component{
    ...
    componentWillMount(){
        ...
        this.state.ary=localStorage.getItem("myLikeSong") ? JSON.parse(localStorage.getItem("myLikeSong")) : [];
    }
    componentDidMount(){
                                ...
                                songs.map((song,index) => (
                                    <li key={index} data-song={song}>
                                        ...
                                        <div className="li-right">
                                            <i className={this.state.ary.find(item=>item.id==song.id)?"iconfont icon-xin1":"iconfont icon-xin"} onClick={(e) => this.changeLike(e,song)}></i>
